...
function Configurator(model, options, configuration, annotations) {
    ...
    if (options.alreadyDisplayed === false)
...
Configurator.prototype.render = function (configuration, annotations) {
    ...
    if ((uiAnnotations == null) || (uiAnnotations == undefined) || (uiAnnotations == ""))
        uiAnnotations = this.options.UIAnnotations;


    const configurationRenderer = new ConfigurationRenderer(configuration, this.options, uiAnnotations);
